...
/** Tests for {@link ChannelDataManager}. */
...
public class ChannelDataManagerTest {
    ...
    public void setup() {
        ...
        contentValues.put(
                ...
                Channel.TunerChannelProto.toByteArray(new Channel.TunerChannelProto()));
        ...
        mChannelDataManager = new ChannelDataManager(RuntimeEnvironment.application);
    }
